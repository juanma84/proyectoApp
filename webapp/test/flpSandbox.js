		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DemoApp",
									"targetURL": "#ProjectDawprojectdaw-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProjectDawprojectdaw-display": {
								"semanticObject": "ProjectDawprojectdaw",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ProjectDaw.projectdaw",
									"url": sap.ui.require.toUrl("ProjectDaw/projectdaw")
								}
							}
						}
					}
